    ...
    if UPDATES_CHANNEL is not None:
        try:
            ...
            if user.status == "kicked":
               await message.reply_text(
                   text="Sorry Sir, You are Banned to use me. Contact me [BRUNO](https://t.me/BRUNOKLM).",
                   parse_mode="markdown",
            ...
            await message.reply_text(
                text="Something went Wrong. Contact me [BRUNO](https://t.me/BRUNOKLM).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton('📢Update', url='https://t.me/KLM_BOTS'),
                    InlineKeyboardButton('Bot List📃', url='https://t.me/KLM_BOTS')
                ],
                [
